...
class QualityStorageTicketItem extends ConsumerWidget {
  const QualityStorageTicketItem({
    super.key,
    required this.index,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    StorageQualityProvider orderPro = ref.watch(storageQualityPro);
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: (ticketsStatus == OrderStatusEnum.completed &&
                    ticket.storageQualityStatus == "rejected")
                ? ColorsUtils.redColor
                : ticket.storageQualityStatus == "accepted"
        ...
        child: Column(
          ...
          children: [
            ...
            ticketsStatus == OrderStatusEnum.pending
                ...
                ? CustomRoundedButton(
                    backgroundColor: ColorsUtils.kPrimaryColor,
                    text: S.of(context).changeStatus,
                    fontSize: 12.spMin,
                    textColor: ColorsUtils.whiteColor,
                    width: 330.w,
                    height: 25.h,
